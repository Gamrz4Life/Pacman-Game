...
GhostManager::GhostManager() :
	...
	ghosts({Ghost(0), Ghost(1), Ghost(2), Ghost(3)})//Creating Ghost Objects
{
...
//Update  ghost speeds
void GhostManager::changespeedman(float multiplier) {
	for (Ghost& ghost : ghosts)
	{
		ghost.changespeed(multiplier);
	}
...
void GhostManager::reset(unsigned char i_level, const std::array<Position, 4>& i_ghost_positions)
{
	...
	//This is how we're increasing the difficulty after each level.
